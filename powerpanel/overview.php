                ...
                <div class="row">
                    <div class="col">
                        <ul class="nav nav-tabs">
                           <li class="nav-item"><a class="nav-link active" id="overview-tab" href="<?php print $this->url('/overview'); ?>" role="tab"><?php I18N::__('Dashboard'); ?></a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col mt-4">
                    <?php
                        if(!empty($admin) && $admin) {
		                    ...
		                    ?>
                                <div class="alert alert-secondary alert-dismissible fade show welcome" role="alert">
