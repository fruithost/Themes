                                    ...
                                    foreach($navigation->getEntries() AS $category) {
                                        ...
                                        ?>
                                            <li class="nav-item dropdown">
                                                <a class="nav-link dropdown-toggle<?php print ($active ? ' active' : ''); ?>" href="#" role="button" aria-expanded="false"><?php print $category->getLabel(); ?></a>
                                                 <ul class="dropdown-menu">
                                                     <?php
                                                        foreach($category->getEntries() AS $entry) {
                                                            // @ToDo Theme-Settings: Icons on Navigation ($entry->icon)
                                                            ?>
                                                               <li><a class="dropdown-item<?php print ($entry->active ? ' active' : ''); ?>" href="<?php print (preg_match('/^(http|https):\/\//Uis', $entry->url) ? $entry->url : $template->url($entry->url)); ?>"<?php print (isset($entry->target) ? sprintf(' target="%s"', $entry->target) : ''); ?>><?php print $entry->name; ?></a></li>
                                                            <?php
                                                        }
                                                    ?>
                                                </ul>
