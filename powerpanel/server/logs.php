        ...
        <div class="row">
            <div class="col">
                <ul class="nav nav-tabs">
                   <li class="nav-item active" aria-current="page"><a class="nav-link" href="<?php print $this->url('/server/logs'); ?>"><?php I18N::__('Logfiles'); ?></a></li>
                </ul>
            </div>
            <div class="col-2 btn-toolbar justify-content-end">
                <a href="<?php print $this->url('/server/logs'); ?>" class="btn btn-sm btn-outline-primary"><?php I18N::__('Refresh'); ?></a>
            </div>
        </div>
    </div>
</div>
